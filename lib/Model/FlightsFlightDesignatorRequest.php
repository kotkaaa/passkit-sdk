<?php
/**
 * FlightsFlightDesignatorRequest
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * FlightsFlightDesignatorRequest Class Doc Comment
 *
 * @category Class
 * @description Used for retrieving details of a particular flight designator.
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class FlightsFlightDesignatorRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'flightsFlightDesignatorRequest';
...
'revision' => 'getRevision'    ];
     ...
     * Sets carrier_code
     *
     * @param string $carrier_code The IATA or ICAO carrier code for the flight.
     *
     * @return $this
     */
     ...
     * Sets revision
     *
     * @param int $revision Revision. Each designator record requires a version number.
     *
     * @return $this
     */
